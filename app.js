...
function uploadToFirebase(data, res) {
  try {
    let url =
      "https://us-central1-waybill-project.cloudfunctions.net//storePdf2";
...
app.post("/generatePdfReport", function (req, res) {
      ...
      .render({
        template: {
          content: fs.readFileSync(
            path.join("./pdfTemplates/injazVoucher.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
  ...
  if (req.body.type == "silk_road_voucher") {
    jsreport
      .render({
        template: {
          content: fs.readFileSync(
            path.join("./pdfTemplates/silk_road_voucher.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
  ...
  if (req.body.type == "trail_balance") {
    ...
    jsreport
      .render({
        template: {
          content: fs.readFileSync(
            path.join("./pdfTemplates/trailBalance.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          ...
          content: fs.readFileSync(
            path.join("./pdfTemplates/tender_claim.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/trucking_company_waybill.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/tender_claim_template.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/check.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/voucher.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/transacton_acc_template.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/closeCashBox.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/tender_claim_excel.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
    ...
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/phospateReport.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
  ...
  if (req.body.type == "AR_claim") {
    jsreport
      .render({
        template: {
          // content: fs.readFileSync(path.join("master.html"), "utf8"),
          content: fs.readFileSync(
            path.join("./pdfTemplates/AR_claim.html"),
            "utf8"
          ),
          engine: "handlebars",
          recipe: "chrome-pdf",
        ...
        data: {
          data: req.body.data,
          cargo_name: req.body.cargo_name,
          tender_claim_id: req.body.tender_claim_id,
          print_date: req.body.print_date,
          cargo_name: req.body.cargo_name,
          pa_name:req.body.pa_name,
          tender_claim_date:req.body.tender_claim_date,
          totalAmount:req.body.totalAmount,
          totalDischargeWeights:req.body.totalDischargeWeights,
